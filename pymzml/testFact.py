...
fac.add([(1383.56, 1417.56, 20000,'TEST'),(1100, 1200, 1000, 'TEST')], style='label.linear.bottom', name='label.spline', color=(255,0,0))
fac.add([(1383.56, 1417.56, 20000,'TEST'),(1100, 1200, 1000, 'TEST')], style='label.spline.bottom', name='label.spline.bottom', color=(255,0,0))
fac.add([(1383.56, 1417.56, 20000,'TEST'),(1100, 1200, 1000, 'TEST')], style='label.spline.top', name='label.spline.top', color=(255,0,0))
